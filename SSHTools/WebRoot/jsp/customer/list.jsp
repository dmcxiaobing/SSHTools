...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/servlet/CustomerServlet?method=catListCustomer"
		method=post>
											...
											<TBODY>
												...
												<c:forEach items="${list }" var="customer">
													<TR
														...
														<TD><a
															href="${pageContext.request.contextPath }/servlet/CustomerServlet?method=editlookCustomer&custId=${customer.cust_id}">修改</a>
															&nbsp;&nbsp; <a
															href="${pageContext.request.contextPath }/servlet/CustomerServlet?method=delete&custId=${customer.cust_id}">删除</a>
														</TD>
													</TR>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												共[<B>${pageBean.totalSize}</B>]条记录,[<B>${pageBean.totalPage}</B>]页 ,每页显示 <select
													name="pageSize">
